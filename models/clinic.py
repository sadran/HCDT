...
class Clinic():
    ...
    def __load_conditions(self, data_config):
        ...
        data_dir = data_config['data_directory']
        csv_file = data_config['conditions']['csv_file']
        ...
        for patient in self.__patients.values():
            if patient.id in conditions_df.index:
                ...
                patient_conditions = patient_conditions[data_config['conditions']['features']]
    ...
    def __load_medications(self, data_config):
        ...
        data_dir = data_config['data_directory']
        csv_file = data_config['medications']['csv_file']
        ...
        for patient in self.__patients.values():
            if patient.id in medications_df.index:
                ...
                # Filter desired columns
                patient_medications = patient_medications[data_config['medications']['features']]
    ...
    def __load_encounters(self, data_config):
        ...
        data_dir = data_config['data_directory']
        csv_file = data_config['encounters']['csv_file']
        ...
        for patient in self.__patients.values():
            if patient.id in encounters_df.index:
                ...
                # Filter desired columns
                patient_encounters = patient_encounters[data_config['encounters']['features']]
    ...
    def __load_procedures(self, data_config):
        ...
        data_dir = data_config['data_directory']
        csv_file = data_config['procedures']['csv_file']
        ...
        for patient in self.__patients.values():
            if patient.id in procedures_df.index:
                ...
                # Filter desired columns
                patient_procedures = patient_procedures[data_config['procedures']['features']]
    ...
    def __load_observations(self, data_config):
        ...
        data_dir = data_config['data_directory']
        csv_file = data_config['observations']['csv_file']
        ...
        for patient in self.__patients.values():
            if patient.id in observations_df.index:
                ...
                # Filter desired columns
                patient_observations = patient_observations[data_config['observations']['features']]
